...
"),
        ...
        public async Task<string> GenerateJs(string prompt) {
            ...
            var queryContext = new List<ChatMessage> {
                new SystemChatMessage(@"You are a coding assistant. Your task is to generate pure, executable JavaScript code based on the user's prompt. The following rules apply:
